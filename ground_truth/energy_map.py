...
if MANUAL_LUT_TEMP_MIN:
    print("The minimum energy for the LUT has been manually set, and it's value is: ", LUT_MIN)
else:
    print("The minimum energy for the LUT will be the minimum value found in the data")

if MANUAL_LUT_TEMP_MAX:
    print("The maximum energy for the LUT has been manually set, and it's value is: ", LUT_MAX)
else:
    print("The maximum energy for the LUT will be the maximum value found in the data")
...
with open("energy_diag.dat") as f:
    for line in f:
        line = line.strip()
        if not line:
            continue
